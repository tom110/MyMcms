...
<body style="overflow-y: hidden;">	
    ...
    <div class="ms-content" style="padding: 40px 0 0 0;">
    	<#if managerModelPage?has_content>
     		<iframe  src="${basePath}/${managerModelPage.managerModelPageUrl?default("/manager/page.html")}" frameborder="0" height="100%" width="100%" id="mainFrame" name="mainFrame" style="background-image: url(${static}/skin/manager/4.5.5/images/loading.gif);  background-repeat: no-repeat;  background-position: center;"></iframe>
     	<#else>
